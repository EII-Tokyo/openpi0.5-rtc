...
_CONFIGS = [
    ...
    _make_twist_train_config(
        ...
        lora=False,
        # 448x448 at larger batches exceeds or destabilizes the 143 GiB H200 memory budget.
        batch_size=64,
        num_workers=64,
        fsdp_devices=4,
        include_low=False,
        ...
        exp_name="no_rinse_cam3_fullft_have_cap_water_return_home_drop_empty_x1_original_45repo_448_bs64_nw64_fsdp4_20260819",
        checkpoint_base_dir="/workspace/openpi0.5-rtc/checkpoints",
        wandb_enabled=True,
        overwrite=True,
        resume=False,
