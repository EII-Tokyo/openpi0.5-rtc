    ...
    *,
    ...
    model = pi0_config.Pi0Config(
        ...
        rl_token=_rl_token.RLTokenConfig(
            ...
            history_mask_ratio=history_mask_ratio,
            zero_margin_weight=zero_margin_weight,
            zero_margin=zero_margin,
            shuffled_margin_weight=shuffled_margin_weight,
...
_CONFIGS = [
    ...
    _make_rl_token_autoencoder_config(
        ...
        repo_ids=_EII_DATA_SYSTEM_WITHOUT_RINSE_RETURN_HOME_TURN_OVER_X5_FREE_SPIN_PLUS10_REPO_IDS,
        init_checkpoint="/workspace/openpi0.5-rtc/checkpoints/eii_data_system_without_rinse_cam3_fullft_h200_return_home_29repo/no_rinse_cam3_fullft_return_home_29repo_bs256_nw64_fsdp4_20260520/19000/params",
        batch_size=16,
        num_workers=4,
        fsdp_devices=1,
        gradient_accumulation_steps=1,
    ...
    _make_rl_token_autoencoder_config(
        "eii_data_system_without_rinse_cam3_fullft_h200_return_home_29repo_rl_token_masked_tf",
        repo_ids=_EII_DATA_SYSTEM_WITHOUT_RINSE_RETURN_HOME_TURN_OVER_X5_FREE_SPIN_PLUS10_REPO_IDS,
        init_checkpoint="/workspace/openpi0.5-rtc/checkpoints/eii_data_system_without_rinse_cam3_fullft_h200_return_home_29repo/no_rinse_cam3_fullft_return_home_29repo_bs256_nw64_fsdp4_20260520/19000/params",
        batch_size=16,
        num_workers=4,
        fsdp_devices=1,
        gradient_accumulation_steps=1,
        exp_name="rl_token_2048_enc4_dec4_masked_tf075_from_19000_20260528",
        assets_base_dir="/workspace/openpi0.5-rtc/assets",
        checkpoint_base_dir="/workspace/openpi0.5-rtc/checkpoints",
        wandb_enabled=True,
        overwrite=False,
        ...
        decoder_mode="teacher_forced",
        history_mask_ratio=0.75,
    ),
    _make_rl_token_autoencoder_config(
        "eii_data_system_without_rinse_cam3_fullft_h200_return_home_29repo_rl_token_query",
        repo_ids=_EII_DATA_SYSTEM_WITHOUT_RINSE_RETURN_HOME_TURN_OVER_X5_FREE_SPIN_PLUS10_REPO_IDS,
        init_checkpoint="/workspace/openpi0.5-rtc/checkpoints/eii_data_system_without_rinse_cam3_fullft_h200_return_home_29repo/no_rinse_cam3_fullft_return_home_29repo_bs256_nw64_fsdp4_20260520/19000/params",
        batch_size=16,
        num_workers=4,
        fsdp_devices=1,
        gradient_accumulation_steps=1,
        exp_name="rl_token_2048_enc4_dec4_query_from_19000_20260528",
        assets_base_dir="/workspace/openpi0.5-rtc/assets",
        checkpoint_base_dir="/workspace/openpi0.5-rtc/checkpoints",
        wandb_enabled=True,
        overwrite=False,
    ...
    _make_rl_token_autoencoder_config(
        "eii_data_system_without_rinse_cam3_fullft_h200_return_home_29repo_rl_token_query_margin",
        repo_ids=_EII_DATA_SYSTEM_WITHOUT_RINSE_RETURN_HOME_TURN_OVER_X5_FREE_SPIN_PLUS10_REPO_IDS,
        init_checkpoint="/workspace/openpi0.5-rtc/checkpoints/eii_data_system_without_rinse_cam3_fullft_h200_return_home_29repo/no_rinse_cam3_fullft_return_home_29repo_bs256_nw64_fsdp4_20260520/19000/params",
        batch_size=16,
        num_workers=4,
        fsdp_devices=1,
        gradient_accumulation_steps=1,
        exp_name="rl_token_2048_enc4_dec4_query_margin_from_19000_20260528",
        assets_base_dir="/workspace/openpi0.5-rtc/assets",
        checkpoint_base_dir="/workspace/openpi0.5-rtc/checkpoints",
        wandb_enabled=True,
        overwrite=False,
        ...
        num_train_steps=12_001,
        decoder_mode="query",
        zero_margin_weight=0.5,
        zero_margin=0.5,
        shuffled_margin_weight=0.25,
        shuffled_margin=0.1,
    ),
    _make_twist_train_config(
