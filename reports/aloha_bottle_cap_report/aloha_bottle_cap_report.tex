...
\newcommand{\coverrow}[2]{%
  \textbf{\color{ReportNavy}#1} & #2\\[1.4mm]%
}
...
\coverrow{项目阶段}{第一年工作总结与下一年度工作设计}
\coverrow{正式部署模型}{2026年5月训练、现场采用第19,000步保存版本}
\coverrow{事实源版本}{主仓库审计提交：\texttt{c90f1854}（完整编号见内部审计）}
\coverrow{报告日期}{2026年7月30日}
\coverrow{报告版本}{v2.0（无演示视频、证据分级版）}
\coverrow{作者}{\underline{\hspace{75mm}}}
\end{tabular}\par
\vspace{3mm}
