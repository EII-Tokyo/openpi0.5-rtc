...
const initialRLT: RLTControlState = {
  ...
  online_safety_phase: 'idle_wait_new_data',
  online_round_index: 0,
  online_last_committed_shards: 0,
  online_last_committed_success: 0,
  online_last_committed_failure: 0,
  online_round_start_shards: 0,
  online_round_start_success: 0,
  online_round_start_failure: 0,
  online_critic_steps_remaining: 0,
  online_actor_steps_remaining: 0,
  online_best_critic_auc: null,
  online_best_critic_q_gap: null,
  online_rejection_reason: null,
  online_target_delta_norm: 0.04,
  online_min_new_shards_per_round: 10,
  online_min_new_success_per_round: 5,
  online_min_new_failure_per_round: 5,
  ...
  online_actor_min_q_advantage: 0,
  online_beta_initial: 30,
  online_beta_min: 5,
  online_beta_max: 30,
