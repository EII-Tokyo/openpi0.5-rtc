...
class ValueDataConfig:
    ...
    # Path to a prompt-swap manifest parquet generated by
    # data/augmented/generate_prompt_swap_manifest.py.  Each row maps a
    # source episode to a swapped task prompt.  At init time the dataloader
    # creates augmented failure EpisodeMetadata entries that read frames from
    # the source success dataset but use the swapped prompt.
    prompt_swap_manifest: str | None = None
