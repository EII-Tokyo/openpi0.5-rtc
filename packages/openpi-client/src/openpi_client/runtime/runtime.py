...
class Runtime:
    ...
    def __init__(
        ...
        self._rlt_state = {
            ...
            "intervention_ramp_steps": int(os.getenv("RLT_DEFAULT_INTERVENTION_RAMP_STEPS", "10")),
            "actor_execution_mode": os.getenv("RLT_ACTOR_EXECUTION_MODE", "wait_next_chunk"),
            "actor_action_horizon": int(os.getenv("RLT_ACTOR_ACTION_HORIZON", "10")),
            "actor_wait_timeout_sec": float(os.getenv("RLT_ACTOR_WAIT_TIMEOUT_SEC", "0")),
            "disable_vla_tail_when_actor_active": os.getenv(
                "RLT_DISABLE_VLA_TAIL_WHEN_ACTOR_ACTIVE", "1"
