...
STAGE="$BUNDLE_ROOT/remote_stream_cap_stage.usda"
LOADER="$BUNDLE_ROOT/tools/remote_stream_cap_stage_loader.py"
REPORT="$BUNDLE_ROOT/remote_cap_stage_loader_report.json"
LOG="$BUNDLE_ROOT/remote_stream_cap_stage_loader.log"
EXPECTED_SHA=41af2047922e10cc415c84bf57a2f1965ede9fb3f9e58cef27618d1bb9a6874b
